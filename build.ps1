...
if ($CreatePackages) {
    ...
    dotnet pack ".\src\XdtExtensions\XdtExtensions.csproj" -p:IncludeSymbols=true -p:SymbolPackageFormat=snupkg -c Release /p:PackageOutputPath=$packageOutputFolder
}
